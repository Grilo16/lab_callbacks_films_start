...
describe('Cinema', function () {
  ...
  it('should be able to filter films by genre', function(){
    const filmsByGenre = cinema.getFilmByGenre("drama")
    assert.deepStrictEqual(filmsByGenre, [moonlight, trainspotting])
  });


  it('should be able to find a film by title', function(){
    const filmsByTitle = cinema.getFilmByTitle("Dunkirk")
    assert.deepStrictEqual(filmsByTitle, [dunkirk])
  });
